...
daily_activity <- load_and_clean_daily_activity("../02_Datas/dailyActivity_merged.csv")
sleep_day <- load_and_clean_sleep_data("../02_Datas/sleepDay_merged.csv")
weight_info <- load_and_clean_weight_data("../02_Datas/weightLogInfo_merged.csv")
